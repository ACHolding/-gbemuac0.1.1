...
def _package_needs_install(distribution: str, minimum: str, module: str) -> bool:
    try:
        ...
        return False
    except (importlib.metadata.PackageNotFoundError, ImportError, OSError):
        return True
...
def ensure_dependencies() -> None:
    ...
    # pygame-ce imports as ``pygame``. If another compatible pygame is already
    # importable, it is fine for this frontend and no replacement is forced.
    try:
